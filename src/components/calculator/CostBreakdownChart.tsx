  ...
  return (
    <GlassCard
      ...
      badge={
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className="px-2.5 py-0.5 rounded-full bg-purple-500/15 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 border border-purple-500/30 text-xs font-semibold">
            %{b.grossMarginPercentage} Brüt Marj
          </span>
          <span className="px-2.5 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-purple-300 border border-slate-200 dark:border-slate-700 text-xs font-mono font-bold">
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col sm:flex-row items-center justify-center gap-6 p-4 rounded-2xl bg-slate-50/80 dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800">
          <div className="relative w-44 h-44 shrink-0 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
              <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Kar Oranı</span>
              <span className="text-xl font-black text-emerald-600 dark:text-emerald-400 font-mono">
                {formatPercent(b.profitRatio)}
              </span>
              <span className="text-[9px] text-slate-400 dark:text-slate-500">Satış İçinde</span>
            </div>
          </div>
              ...
              return (
                <div key={idx} className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-1.5 truncate">
                    ...
                    <span className="text-slate-700 dark:text-slate-300 truncate text-[11px]">{seg.name}</span>
                  </div>
                  <span className="font-mono text-slate-900 dark:text-slate-200 font-semibold shrink-0 text-[11px]">
                    %{pct.toFixed(1)}
                  </span>
                </div>
              );
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs text-slate-700 dark:text-slate-300 font-semibold">
              ...
              <span className="text-emerald-600 dark:text-emerald-400 font-mono">Toplam: {formatCurrency(b.finalSellingPrice, activeCurrency)}</span>
            </div>
            <div className="w-full h-3 rounded-full bg-slate-200 dark:bg-slate-900 overflow-hidden flex">
              <div
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 pt-2">
            ...
            <div className="p-3 rounded-xl bg-slate-50/80 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800">
            ...
            <div className="p-3 rounded-xl bg-slate-50/80 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800">
              ...
              <div className="text-base sm:text-lg font-bold text-amber-600 dark:text-amber-300 font-mono mt-1">
                {formatCurrency(b.effectiveHourlyYield, activeCurrency)}/sa
              </div>
              <div className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">
            ...
            <div className="p-3 rounded-xl bg-slate-50/80 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800">
              ...
              <div className="text-base sm:text-lg font-bold text-indigo-600 dark:text-indigo-300 font-mono mt-1">
            ...
            <div className="p-3 rounded-xl bg-slate-50/80 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800">
              ...
              <div className="text-base sm:text-lg font-bold text-sky-600 dark:text-sky-300 font-mono mt-1">
                {formatCurrency(b.costPerSqM, activeCurrency)}/m²
              </div>
              <div className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">
                Mimari & Vitray Panel Birimi
              </div>
            </div>
