...
export const QuickCostSummary: React.FC = () => {
  ...
  return (
    <div className="relative rounded-3xl bg-slate-900/90 border border-slate-800 p-5 md:p-6 shadow-xl overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-6">
        ...
        <div className="flex items-start sm:items-center gap-4 border-b lg:border-b-0 lg:border-r border-slate-800/80 pb-5 lg:pb-0 lg:pr-8 shrink-0">
          <div className="w-13 h-13 rounded-2xl bg-slate-950 border border-slate-800 flex items-center justify-center text-amber-400 shrink-0 shadow-inner">
          ...
          <div>
            ...
            <div className="text-3xl md:text-4xl font-extrabold text-white tracking-tight mt-0.5 font-mono">
              {formatCurrency(b.finalSellingPrice, activeCurrency)}
            </div>
            <div className="text-xs text-slate-400 mt-1 flex items-center gap-2.5 font-mono">
              <span>Temel: <b className="text-slate-200">{formatCurrency(b.rawBaseCost, activeCurrency)}</b></span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 flex-1">
          ...
          {/* Glass & Consumables */}
          <div className="rounded-2xl bg-slate-950/60 border border-slate-800/80 p-3 flex flex-col justify-between">
            <div className="flex items-center justify-between text-slate-400 text-xs">
              <span className="text-[11px] font-medium">{t.summary.materialCost}</span>
              <Layers className="w-3.5 h-3.5 text-cyan-400" />
            </div>
            <div className="text-sm sm:text-base font-bold text-slate-100 mt-1 font-mono">
          ...
          <div className="rounded-2xl bg-slate-950/60 border border-slate-800/80 p-3 flex flex-col justify-between">
            ...
            <div className="text-sm sm:text-base font-bold text-amber-300 mt-1 font-mono">
          ...
          <div className="rounded-2xl bg-slate-950/60 border border-slate-800/80 p-3 flex flex-col justify-between">
            ...
            <div className="text-sm sm:text-base font-bold text-emerald-400 mt-1 font-mono">
        ...
        <div className="flex sm:flex-col justify-end gap-2 shrink-0">
          <button
            ...
            className="tactile-btn flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md shadow-indigo-950/40"
          >
          ...
          <button
            ...
            className="tactile-btn flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-800 text-slate-300 text-xs font-semibold"
